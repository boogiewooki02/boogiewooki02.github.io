  ...
  build() {
    return flow;
        ...
        <section className="section about" id="about">
          ...
          <div className="history"><div><time>2022.03 —</time><strong>홍익대학교</strong><span>컴퓨터공학과</span></div><div><time>2025.03 — 09</time><strong>SK Networks AI Camp</strong><span>13기 수료</span></div><div><time>2025.07 —</time><strong>ToBig's</strong><span>24기</span></div><div><time>2026.03 —</time><strong>CEOS</strong><span>23기 Backend</span></div></div>
        </section>
      </main>
